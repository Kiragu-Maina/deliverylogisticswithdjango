...
class PendingForm(models.Model):
   ...
   def __str__(self):
        return '{} {} {} {} {}'.format(self.podstatus, self.shop_name, self.invoicepicture, self.user, self.OrderDate)
...
class PodStatus(models.Model):
   ...
   user = models.CharField(max_length = 32, unique = True)
   def __str__(self):
        return '{} {} {} {}'.format(self.podstatus, self.shop_name, self.OrderDate, self.user)
...
class ContactForm(models.Model):
   ...
   def __str__(self):
        return '{} {} {} {} {} {} {}'.format(self.shop_name, self.completion_status, self.message, self.user, self.OrderTime, self.OrderDate, self.invoicepicture)
...
class kenchiccnew(models.Model):
   ...
   def __str__(self):
        return '{} {} {} {}'.format(self.Customer_Name, self.Posting_Description, self.Route_Plan, self.Ordered_Weight)
