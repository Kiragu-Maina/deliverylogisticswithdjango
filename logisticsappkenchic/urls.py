...
from pages.views import register_page, login_page, home_page, logout_user, admin2, login_admin, workerror, generate_report_view, serve_apk, pending, upload_file
...
urlpatterns = [
    ...
    path('report/', generate_report_view, name="report"),
